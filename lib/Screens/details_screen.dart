...
import 'package:flutter_yoga/services/Chapter.dart';
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      GestureDetector(onTap:(){Navigator.push(context, MaterialPageRoute(builder: (context)=>Chapter()));},child: ChapterCard(
                        name: "",
                        chapterNumber: 1,
                        tag: "You are not your mind",
                        press: () {},
                      ),),
                      ChapterCard(
                        name: "",
                      ...
                      ChapterCard(
                        name: "",
                        chapterNumber: 3,
                        tag: "Moving deeply into the now",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "",
                        chapterNumber: 4,
                        tag: "Mind strategies for avoiding the now",
                        press: () {},
                      ),
                      SizedBox(height: 10),
                    ],
